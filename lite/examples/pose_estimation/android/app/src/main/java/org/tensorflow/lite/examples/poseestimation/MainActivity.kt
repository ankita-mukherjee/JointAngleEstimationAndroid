...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var tvMemoryUsageMB: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvMemoryUsageMB= findViewById(R.id.tvMemoryUsageMB)
            ...
            if (cameraSource == null) {
                cameraSource =
                    CameraSource(surfaceView, object : CameraSource.CameraSourceListener {
                        override fun onFPSListener(fps: Int, mem_mb: Long) {
                            tvFPS.text = getString(R.string.tfe_pe_tv_fps, fps)
                            tvMemoryUsageMB.text = getString(R.string.tfe_pe_tv_mem_mb, mem_mb)
